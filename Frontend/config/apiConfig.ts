...
export const API_ENDPOINTS = {
  ...
  COLLABORATION: {
    SHARED_CONTENT: `${API_BASE_URL}/collaboration/content`,
    LIST_CONTENT: `${API_BASE_URL}/collaboration/content`,
    CREATE_CONTENT: `${API_BASE_URL}/collaboration/content`,
    CREATE_SHARED_CONTENT: `${API_BASE_URL}/collaboration/content`,
    GET_SHARED_CONTENT: (id: string) => `${API_BASE_URL}/collaboration/content/${id}`,
    UPDATE_SHARED_CONTENT: (id: string) => `${API_BASE_URL}/collaboration/content/${id}`,
    DELETE_SHARED_CONTENT: (id: string) => `${API_BASE_URL}/collaboration/content/${id}`,
    DELETE_CONTENT: (id: string) => `${API_BASE_URL}/collaboration/content/${id}`,
    LIKE_CONTENT: (id: string) => `${API_BASE_URL}/collaboration/content/${id}/like`,
    TOGGLE_LIKE: (id: string) => `${API_BASE_URL}/collaboration/content/${id}/like`,
    COMMENT_CONTENT: (id: string) => `${API_BASE_URL}/collaboration/content/${id}/comments`,
