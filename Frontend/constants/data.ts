...
export const upgradePlanDetails = [
  {
    ...
    price: 0,
    features: [
      "Access to UniHub mini and reasoning",
      "Standard voice mode",
      "Real-time data from the web with search",
      "Limited access to UniHub",
    ],
    notProvidedFeatures: [
  ...
  },
  {
    ...
    notProvidedFeatures: ["Use custom UniHub"],
  },
  {
    id: uuidv4(),
    name: "Premium",
...
export const faqData = [
  {
    id: uuidv4(),
    question: "What is UniHub?",
    answer:
      "Yes! With UniHub, you can design and customize your chatbot, set response patterns, and integrate it into websites or applications.",
  },
  {
    id: uuidv4(),
    question: "How does UniHub work?",
    answer:
      "Yes! With UniHub, you can design and customize your chatbot, set response patterns, and integrate it into websites or applications.",
  },
  {
  ...
  {
    id: uuidv4(),
    question: "Is coding knowledge required to use UniHub?",
    answer:
      "Yes! With UniHub, you can design and customize your chatbot, set response patterns, and integrate it into websites or applications.",
  },
  {
    id: uuidv4(),
    question: "What industries can use UniHub?",
    answer:
      "Yes! With UniHub, you can design and customize your chatbot, set response patterns, and integrate it into websites or applications.",
  },
  {
    id: uuidv4(),
    question: "Does UniHub support multiple languages?",
    answer:
      "Yes! With UniHub, you can design and customize your chatbot, set response patterns, and integrate it into websites or applications.",
  },
  {
    id: uuidv4(),
    question: "Can I integrate UniHub with my website or app?",
    answer:
      "Yes! With UniHub, you can design and customize your chatbot, set response patterns, and integrate it into websites or applications.",
  },
  {
    id: uuidv4(),
    question: "Is there a free version of UniHub?",
    answer:
      "Yes! With UniHub, you can design and customize your chatbot, set response patterns, and integrate it into websites or applications.",
  },
  {
    id: uuidv4(),
    question: "How secure is UniHub?",
    answer:
      "Yes! With UniHub, you can design and customize your chatbot, set response patterns, and integrate it into websites or applications.",
  },
  {
    id: uuidv4(),
    question: "How do I get started with UniHub?",
    answer:
      "Yes! With UniHub, you can design and customize your chatbot, set response patterns, and integrate it into websites or applications.",
  },
];
...
export const explorePageData = [
  {
    ...
    articles: [
      ...
      },
      {
        ...
        desc: "Official UniHub from the Mermaid team. Generate a Mermaid diagram or chart with text including video generator and video editor in one.",
        icon: icon2,
      },
      {
        id: uuidv4(),
  ...
  },
  {
    id: uuidv4(),
    title: "Trending",
    desc: "Most popular UniHub by our community",
    articles: [
      {
        id: uuidv4(),
